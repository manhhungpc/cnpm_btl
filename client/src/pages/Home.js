...
export default function Home() {
  return (
    <div className={styles1.background}>
      ...
      <h2 align="center">Helpy có những gì?</h2>
      ...
      <Slider
        ...
        title={"Helpyhelp"}
        subtitle={"Helpyhelp là những người sẽ giúp đỡ Helpyneed. Công việc dù có khó khăn, vất vả đến đâu cũng sẽ được họ giải quyết trọn vẹn. Mang đến niềm vui và sự hài lòng dành cho bạn."}
        flipped={true}
      />
      <Footer />
    </div>
